...
with col_menu:
    ...
    escolha = st.radio(
        "",
        ["📚 Aprender sobre um site","🌐 Pesquisar na Web","📤 Importar Leads","🌍 Web Scraping Web Summit"], #,"📁 Enviar Arquivo","🗣️ Falar com a RANA","📆 Google Calendar", "🎤 Observar Reunião","📲 Criar post para redes", "🎨 Alternar tema"],
        index=1
    )
